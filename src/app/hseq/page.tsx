      ...
      <section className="relative isolate overflow-hidden bg-navy-deep text-white">
        ...
        <div className="container-prose relative py-32 md:py-40">
          ...
          <h1 className="mt-6 max-w-3xl font-display text-5xl font-bold md:text-7xl">
            Safety First. <span className="text-gold">Quality</span> Always. Environment Protected.
          </h1>
        </div>
      </section>
      ...
      <section className="bg-background py-24">
        <div className="container-prose">
          <div className="mx-auto mb-16 max-w-2xl text-center">
            ...
            <h2 className="mt-4 font-display text-4xl font-bold text-navy-deep">Zero-compromise standards across every operation.</h2>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              { icon: ShieldCheck, n: "03", t: "Quality Assurance & Asset Integrity", d: "All general merchandise, communication devices, and oil production tools imported or supplied by Prime Rig Ventures Limited pass rigid quality testing, ensuring structural durability and operational longevity." },
            ].map((p) => (
              <article key={p.t} className="group relative overflow-hidden border border-border bg-card p-10 transition-all hover:border-gold hover:shadow-xl">
                <span className="absolute right-6 top-6 font-display text-5xl font-bold text-gold/20 transition-colors group-hover:text-gold/50">{p.n}</span>
                <div className="flex h-14 w-14 items-center justify-center bg-navy-deep text-gold">
                  <p.icon className="h-7 w-7" />
                </div>
                <h3 className="mt-8 font-display text-2xl font-bold text-navy-deep">{p.t}</h3>
      ...
      <section className="bg-secondary py-20">
        <div className="container-prose grid gap-8 text-center md:grid-cols-4">
          {[
            ...
            <div key={s.l}>
              <div className="font-display text-5xl font-bold text-navy-deep">{s.v}</div>
